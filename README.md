...
> 使用本游戏即表示你同意 **[《使用条款与免责声明》（TERMS.md）](docs/TERMS.md)** 全部内容。以下为要点摘录，完整具法律效力的条款以 TERMS.md 为准。
...
- 本游戏按 **「现状」（AS IS）** 提供，不附带任何明示或默示担保；在适用法律允许的最大范围内，作者对因使用本游戏、任何用户内容或所接入第三方服务而产生的任何损害不承担责任。详见 [TERMS.md](docs/TERMS.md)。
